"""
Configuration settings for Layered Context Graph System
Simplified, source-first, scaffold-guided approach
"""
...
DEFAULT_CONFIG = {
    ...
    'preserve_code_blocks': True,  # Protect technical content
    ...
    'scaffold_alignment_threshold': 0.8,  # Structure preservation
...
OLLAMA_CONFIG = {
    **DEFAULT_CONFIG,
    'model_type': 'ollama',
    'model_name': 'qwq',
    'gguf_path': '/workspace/qwq.gguf',
    'static_analysis': True,  # Analyze weights without inference
}
